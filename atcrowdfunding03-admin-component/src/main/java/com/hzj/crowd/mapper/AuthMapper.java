...
public interface AuthMapper {
    ...
    void deleteAssignByRoleId(Integer roleId);

    void createAssignByAuthIds(@Param("authIdList") List<Integer> authIdList,@Param("roleId") Integer roleId);
